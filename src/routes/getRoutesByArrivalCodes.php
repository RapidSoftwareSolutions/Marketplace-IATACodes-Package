<?php
$app->post('/api/IATACodes/getRoutesByArrivalCodes', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'arrivalCodes']);
    ...
    $body['arrival'] = $post_data['args']['arrivalCodes'];
