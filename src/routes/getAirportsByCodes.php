<?php
$app->post('/api/IATACodes/getAirportsByCodes', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'airportCodes']);
    ...
    $body['code'] = $post_data['args']['airportCodes'];
