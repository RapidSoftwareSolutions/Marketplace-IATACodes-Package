<?php
$app->post('/api/IATACodes/getSingleAirportTimetable', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'airportCode']);
    ...
    $query_str = $settings['api_url'] . "timetable";
    $body = array();
