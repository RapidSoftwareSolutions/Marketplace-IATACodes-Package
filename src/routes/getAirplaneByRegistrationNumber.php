<?php
$app->post('/api/IATACodes/getAirplaneByRegistrationNumber', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'airplaneRegistrationNumber']);
    ...
    $query_str = $settings['api_url'] . "airplanes";
    $body = array();
    $body['api_key'] = $post_data['args']['apiKey'];
    $body['reg_num'] = $post_data['args']['airplaneRegistrationNumber'];
