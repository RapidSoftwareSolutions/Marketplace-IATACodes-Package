<?php
$app->post('/api/IATACodes/getAircraftsByCodes', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'aircraftCodes']);
    ...
    $body['code'] = $post_data['args']['aircraftCodes'];
