<?php
$app->post('/api/IATACodes/getCitiesByCodes', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'cityCodes']);
    ...
    $body['code'] = is_array($post_data['args']['cityCodes']) ? implode(',', $post_data['args']['cityCodes']) : $post_data['args']['cityCodes'];
