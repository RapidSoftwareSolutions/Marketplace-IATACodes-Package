<?php
$app->post('/api/IATACodes/getCountriesByCodes', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'countryCodes']);
    ...
    $body['code'] = $post_data['args']['countryCodes'];
